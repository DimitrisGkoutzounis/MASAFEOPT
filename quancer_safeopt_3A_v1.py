...
y_estimated, os1_estimated, os2_estimated, os3_estimated = run_experiment(
    x_estimated_1[0], x_estimated_1[1],
    x_estimated_2[0], x_estimated_2[1],
    x_estimated_3[0], x_estimated_3[1],
    final_iteration)
