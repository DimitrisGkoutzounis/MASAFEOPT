...
#ifndef RTW_HEADER_servoPDF_h_
#define RTW_HEADER_servoPDF_h_
#ifndef servoPDF_COMMON_INCLUDES_
#define servoPDF_COMMON_INCLUDES_
#include <stdlib.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* servoPDF_COMMON_INCLUDES_ */
...
#define servoPDF_rtModel               RT_MODEL_servoPDF_T

/* Block signals (default storage) */
typedef struct {
  real_T countstorad;                  /* '<S1>/counts to rad' */
  real_T Clock;                        /* '<Root>/Clock' */
  real_T magnituderad;                 /* '<Root>/magnitude  (rad)' */
  real_T theta_d;                      /* '<Root>/Switch' */
  real_T ModelArgument;                /* '<Root>/Model Argument' */
  real_T FilteredDerivative;           /* '<Root>/Filtered Derivative' */
  real_T ModelArgument1;               /* '<Root>/Model Argument1' */
  real_T u;                            /* '<Root>/Sum3' */
  real_T Vm;                           /* '<Root>/Saturation1' */
} B_servoPDF_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_AOVoltages;     /* '<S1>/HIL Initialize' */
  ...
  real_T HILRead_AnalogBuffer;         /* '<S1>/HIL Read' */
...
#define rtB                            servoPDF_B
#define BlockIO                        B_servoPDF_T
#define rtX                            servoPDF_X
#define ContinuousStates               X_servoPDF_T
#define rtXdot                         servoPDF_XDot
#define StateDerivatives               XDot_servoPDF_T
#define tXdis                          servoPDF_XDis
#define StateDisabled                  XDis_servoPDF_T
#define rtP                            servoPDF_P
#define Parameters                     P_servoPDF_T
#define rtDWork                        servoPDF_DW
#define D_Work                         DW_servoPDF_T

/* Parameters (default storage) */
struct P_servoPDF_T_ {
  real_T t_run;                        /* Variable: t_run
                                        * Referenced by:
                                        *   '<Root>/Switch1'
                                        *   '<Root>/Switch2'
                                        *   '<Root>/Switch3'
                                        */
  real_T triangular_rep_seq_y[5];      /* Mask Parameter: triangular_rep_seq_y
  ...
  real_T HILInitialize_POInitial;      /* Expression: initial_pwm_outputs
                                        * Referenced by: '<S1>/HIL Initialize'
                                        */
  real_T countstorad_Gain;             /* Expression: pi/1024
  ...
  real_T step_PhaseDelay;              /* Expression: 0
                                        * Referenced by: '<Root>/step'
                                        */
  real_T magnituderad_Gain;            /* Expression: 1
...
extern P_servoPDF_T servoPDF_P;

/* Block signals (default storage) */
extern B_servoPDF_T servoPDF_B;

/* Continuous states (default storage) */
extern X_servoPDF_T servoPDF_X;

/* Disabled states (default storage) */
extern XDis_servoPDF_T servoPDF_XDis;

/* Block states (default storage) */
extern DW_servoPDF_T servoPDF_DW;

/* Model entry point functions */
extern void servoPDF_initialize(void);
extern void servoPDF_output(void);
extern void servoPDF_update(void);
extern void servoPDF_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern servoPDF_rtModel *servoPDF(void);
...
extern RT_MODEL_servoPDF_T *const servoPDF_M;
 ...
 *
 * '<Root>' : 'servoPDF'
 * '<S1>'   : 'servoPDF/DC-servo'
 * '<S2>'   : 'servoPDF/triangular'
 */
#endif                                 /* RTW_HEADER_servoPDF_h_ */
