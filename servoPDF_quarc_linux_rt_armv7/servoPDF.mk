###########################################################################
## Makefile generated for component 'servoPDF'. 
## 
## Makefile     : servoPDF.mk
## Generated on : Wed Oct 09 18:38:29 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/servoPDF.rt-linux_rt_armv7
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/servoPDF.rt-linux_rt_armv7
...
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=1 -DALLOCATIONFCN=0 -DEXT_MODE=1 -DMAT_FILE=1 -DONESTEPFCN=0 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
DEFINES_OPTS = -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1
DEFINES_QUARC = -DASSERTIONS=1 -DDOASSERTS
DEFINES_STANDARD = -DMODEL=servoPDF -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/servoPDF_quarc_linux_rt_armv7/rtGetInf.c $(START_DIR)/servoPDF_quarc_linux_rt_armv7/rtGetNaN.c $(START_DIR)/servoPDF_quarc_linux_rt_armv7/rt_nonfinite.c $(START_DIR)/servoPDF_quarc_linux_rt_armv7/servoPDF.c $(START_DIR)/servoPDF_quarc_linux_rt_armv7/servoPDF_data.c $(START_DIR)/servoPDF_quarc_linux_rt_armv7/servoPDF_main.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = rt_logging.o rtGetInf.o rtGetNaN.o rt_nonfinite.o servoPDF.o servoPDF_data.o servoPDF_main.o rt_sim.o ext_svr.o updown.o ext_work.o
...
LIBS = C:/PROGRA~1/Quanser/QUARC/lib/LI8EF6~1/libhil.a C:/PROGRA~1/Quanser/QUARC/lib/LI8EF6~1/LI5A2F~1.A C:/PROGRA~1/Quanser/QUARC/lib/LI8EF6~1/LIBQUA~4.A
...
%.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
rtGetInf.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"


servoPDF.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/servoPDF.c
	$(CC) $(CFLAGS) -o"$@" "$<"


servoPDF_data.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/servoPDF_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


servoPDF_main.o : $(START_DIR)/servoPDF_quarc_linux_rt_armv7/servoPDF_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"
